          ...
          <div className="row">
            ...
            <div className="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-left">
              <div className="content pt-4 pt-lg-0">
                <h3>¿Quiénes somos?</h3>
                <p style={{textAlign: 'justify'}}className="fst-italic">
              ...
              <ul>
                <li><i className="bi bi-check-circle"></i> Conexión entre empresas y personas.</li>
                <li><i className="bi bi-check-circle"></i> Facilitación del proceso de contratación.</li>
            ...
            <div className="col-lg-6 mt-2 mb-lg-0 order-2 order-lg-1">
              <ul className="nav nav-tabs flex-column">
                <li className="nav-item" data-aos="fade-up">
                  ...
                  <h4>Oportunidades</h4>
                  <p style={{textAlign: 'justify'}}>La app de 'Acá Estamos' ha sido creada pensando en brindar oportunidades laborales a las personas que residen en la comuna de Renca. Queremos fortalecer nuestra comunidad local y apoyar a aquellos que se encuentran cerca. Sin embargo, valoramos el interés de todas las personas y les invitamos a explorar otras plataformas y oportunidades que se ajusten a sus necesidades. ¡Siempre hay opciones para todos.</p>
                </a>
              </li>
              <li className="nav-item mt-2" data-aos="fade-up" data-aos-delay="100">
                <a className="nav-link" data-bs-toggle="tab" href="#tab-2">
                  ...
                  <p style={{textAlign: 'justify'}}>Los talentos pueden registrarse de manera sencilla. Solo necesitas crear una cuenta y proporcionar tu información personal y laboral. Luego, podrás cargar tu currículum para que las empresas puedan conocer tus habilidades y experiencia.
                  </p>
                </a>
              </li>
              <li className="nav-item mt-2" data-aos="fade-up" data-aos-delay="200">
                <a className="nav-link" data-bs-toggle="tab" href="#tab-3">
                  ...
                  <p style={{textAlign: 'justify'}}>Es importante completar tu perfil de manera detallada. Puedes agregar información sobre tu experiencia laboral, habilidades, educación y otros detalles relevantes. Esto permitirá que las empresas tengan una visión completa de tu perfil y te consideren para posibles contrataciones.</p>
                </a>
              </li>
              <li className="nav-item mt-2" data-aos="fade-up" data-aos-delay="300">
                <a className="nav-link" data-bs-toggle="tab" href="#tab-4">
                  ...
                  <p style={{textAlign: 'justify'}}>Recuerda que solo las empresas te pueden contactar.Si una empresa está interesada en tu perfil, podrán enviarte mensajes a través de la plataforma para coordinar entrevistas o brindarte más información sobre el puesto.</p>
                  </a>
                </li>
              </ul>
            </div>
