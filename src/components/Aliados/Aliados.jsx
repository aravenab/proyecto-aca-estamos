      ...
      <section id="clients" className="clients">
        <div className="container">
          ...
          <div className="section-title" data-aos="fade-up">
            ...
            <p>En Acá Estamos, hemos logrado permitir que las empresas contacten a los talentos y reducir la tasa de desempleo en nuestra comuna gracias al apoyo invaluable de nuestros aliados. Su colaboración ha sido fundamental para brindar oportunidades laborales a nuestros usuarios y fortalecer el tejido laboral de nuestra comunidad. Estamos agradecidos por su apoyo continuo y compromiso con nuestro objetivo de reducir la desempleabilidad. ¡Juntos, estamos haciendo una diferencia positiva en nuestra comuna!</p>
          </div>
